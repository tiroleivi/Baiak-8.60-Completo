...
CTF_LIB = {
	waitpos = {x = 201, y = 246, z =7}, -- Posição da sala de espera
	tppos = {x = 201, y = 248, z =7}, -- Onde o TP vai aparecer
	...
	teams = {
		["Vermelho"] = {
			...
			flag = {
				id = 1435,
				flag_pos = {x = 654, y = 335, z =6}, -- Posição onde a bandeira vermelha vai ser criada
				gnd_pos = {x = 651, y = 335, z =6}, -- Onde os players da equipe vermelha entregarão a bandeira.
			},
		},
		...
		["Verde"] = {
			...
			flag = {
				id = 1437,
				flag_pos = {x = 602, y = 335, z =6}, -- Posição onde a bandeira verde vai ser criada
				gnd_pos = {x = 605, y = 335, z =6}, -- Onde os players da equipe verde entregarão a bandeira.
			},
		},
	},
}
